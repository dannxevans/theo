...
class IntentReasoningEngine:
    ...
    def reason(
        ...
        # Try LLM reasoning
        try:
            result = self._llm_reason(text, mode, subtab)
    ...
    def _llm_reason(self, text: str, mode: str, subtab: str) -> IntentReasoningResult:
        """
        ...
        system_prompt, user_message = self._build_prompt(text, mode, subtab)

        # Call provider's chat method with system and messages
    ...
    def _build_prompt(self, text: str, mode: str, subtab: str) -> tuple:
...
- plex: Plex Media Server queries (e.g., "what should I watch", "anything new on plex", "what was I watching", "what's on deck")
- whoop: WHOOP fitness tracker queries (e.g., "how did I sleep", "what's my recovery", "strain score")
